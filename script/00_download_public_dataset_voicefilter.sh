...
mkdir VCTK
cd VCTK/ 
(axel -n 10 -q -c "https://datashare.ed.ac.uk/bitstream/handle/10283/3443/VCTK-Corpus-0.92.zip" \
    && { unzip -q VCTK-Corpus-0.92 && mv wav48_silence_trimmed wav48 && rm VCTK-Corpus-0.92.zip; } \
